...
export default function OnboardNavigator() {
  return (
    <Stack.Navigator screenOptions={{headerShown: false}}>
      ...
      />
      <Stack.Screen
        name={NavigationString.COUNTRY_INPUT_SCREEN}
        component={Screens.CountryInput}
      />
      <Stack.Screen
        name={NavigationString.EMAIL_INPUT_SCREEN}
        component={Screens.EmailInput}
      />
      <Stack.Screen
        name={NavigationString.PHONE_INPUT_SCREEN}
        component={Screens.PhoneInput}
      />
      <Stack.Screen
